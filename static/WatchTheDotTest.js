...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function determineFeedback(finalScore) {
    ...
    if (percentage >= 90) {
      feedBack =
        "Excellent peripheral vision! Your visual field appears to be functioning very well.";
      return feedBack;
    }
    if (percentage >= 75) {
    ...
    if (percentage >= 60) {
      feedBack =
        "Moderate peripheral vision. Consider consulting an eye care professional.";
      return feedBack;
    }
    feedBack =
      "Your peripheral vision might need attention. Please consult an eye care professional.";
    return feedBack;
  }
